...
class OverviewImageSideComponent extends HTMLElement {
    constructor(imgSrc, title, description, moreInfo, index) {
        ...
        this.classList.add('overview-component', 'flex', 'flex-col-reverse', 'flex-nowrap', 'justify-center', 'items-center', 'md:grid', 'md:grid-cols-2', 'md:grid-flow-dense', 'pt-0', 'md:pt-12');
...
customElements.define('overview-bottom-component', OverviewImageBottomComponent);

function createOverviewImageBottom(item) {
    const { imgSrc, imgSrcset, title, description, additionalInfo } = item;
    return new OverviewImageBottomComponent(imgSrc, imgSrcset, title, description, additionalInfo);
}
...
const dataGroup1 = [
    {
        ...
        description: "Wish you could speak like a local, no matter where you go? Now it's easy to communicate freely with someone in another language. Simply use the interpreter feature on your Galaxy phone to hear crystal-clear real-time translations through your Galaxy Buds during face-to-face conversations.¹",
        moreInfo: "¹Galaxy AI features by Samsung will be provided for free until the end of 2025 on supported Samsung Galaxy devices.'<br>'²Requires compatible Galaxy device. Samsung account log in and language preset (English and Spanish pre-installed; other languages require free download). Results may vary."
    },
    {
        imgSrc: '/assets/images/product-detail/f2-buds2-pro.png',
        title: 'From phone to ear, translations you can hear',
        description: "From phoning a relative back home to calling in reservations while traveling aboard, break down language barriers with Galaxy Buds and Live Translate. Using the Samsung Phone app, you can hear real-time translations of your conversation clearly through your Buds.¹'²",
        moreInfo: '¹Galaxy AI features by Samsung will be provided for free until the end of 2025 on supported Samsung Galaxy devices.<br> ²Requires compatible Galaxy device. Samsung account log in and language preset (English and Spanish pre-installed; other languages require free download). Results may vary.'
    },
    {
...
const dataGroup2 = [
    {
        ...
        description: 'Studio-quality sound isn’t just for the pros. Feel every note like you’re there with Galaxy Buds2 Pro.³ Now everyone can have a next-level listening experience, whether you’re rocking out to your playlist or staying informed with a podcast.',
...
const dataGroup3 = [
    {
        ...
        description: "Keeping up with your Buds is easy with Smart Things Find.⁹ When a Bud becomes disconnected, you’ll get an alert. If you miss that notification, simply turn on Smart Things Find on your phone. You’ll see a map that points to the last location the Bud was connected. Simply retrieve your Bud, and you’re good to go!",
        moreInfo: "⁹Requires a smartphone with the SmartThings app and a Wi-Fi or Bluetooth connection. Compatible smart devices must be initially set up in the SmartThings app."
    },
    {
        imgSrc: '/assets/images/product-detail/f10-buds2-pro.png',
        title: 'Pairs almost like magic',
        description: "You won’t believe how easy it is to pair Galaxy Buds2 Pro to your other Galaxy devices through your Samsung account — just tap to connect as soon as you open the case.¹⁰ Once paired, Buds2 Pro show up in your list of paired devices. Then with Bluetooth Info Sync, you can effortlessly shift your Buds2 Pro between your Galaxy phone, tablet, or watch.",
        moreInfo: '¹⁰Feature only supported on devices running Samsung One UI 3.1 or later.'
    },
    {
        imgSrc: '/assets/images/product-detail/f11-buds2-pro.png',
        title: 'Best Buds with your TV and PC',
        description: "Next-level sound doesn’t stop at calls and music. Sync Galaxy Buds2 Pro with your Samsung TV for a theatrical experience, or pair them with your PC and lock in to your workflow.¹¹",
        moreInfo: '¹¹Feature supported on Galaxy Book series PCs launched 2020 or later and TV models launched 2022 or later.'
    },
    {
    ...
    },
    {
        ...
        description: "Pop ‘em in and forget they’re there. Galaxy Buds2 Pro are designed to be even more comfortable than before and fit securely no matter what you’re doing. Whether you’re working or working out, make all your moves comfortably.",
        moreInfo: ''
    },
